...
experience:
  ...
  - role: "Research Analyst"
    ...
    description: "Developed high-order and fast solvers for Stokes, Helmholtz, and Lippmann–Schwinger equations, including a scattering-matrix method that achieved a 100× speedup."
education:
  - degree: "Ph.D. in Applied Mathematics"
    institution: "Yale University"
    period: "Aug 2023–May 2027 (expected)"
    description: "Advisors: Yihong Wu and Ronald Coifman."
  - degree: "B.A. in Mathematics and B.A. in Computer Science"
...
- **IEEE Jack Keil Wolf ISIT Student Paper Award (2026):** one of three winners among more than 400 eligible papers.
- ISIT Student Travel Grant and Yale GSA Conference Travel Fellowship (2026).
