...
- **Content:** `src/content/` - Add `.md` files to `pages/`, `posts/`, and `publications/`; identity and CV data live in `bio.md` and `cv.md`
...
- **Two-column layout:** Left sidebar (sticky identity; portrait only on About), Right main (scrollable content)
